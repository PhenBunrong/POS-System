    ...
    <div class="row">
        <div class="col-sm-5">
            <div data-handle="previewArea">
                <img data-handle="mainImage" src="" width="10px" height="20px">
            </div>
            @if(isset($field['crop']) && $field['crop'])
            <div data-handle="previewArea">
                <div class="docs-preview clearfix">
                    <div class="img-preview preview-lg">
                        <img src="https://z1s3.s3.ap-southeast-1.amazonaws.com/assets/photo-left.jpg" style=" min-width: 100px !important; min-height: 100px !important;">
                    </div>
                </div>
            </div>
            @endif
