<style>
    ...
    <div 
        class="form-group col-md-2 col-6 bp-image-full-preview property_image cropperImage" 
        data-aspectRatio="0" data-crop="" data-field-name="image"
        data-init-function="bpFieldInitCropperImageFlexiElement" 
        element="div">
        ...
        <div class="row">
            <div class="col-sm-6 overflow-hidden image-auto-height"
                ...
                <div style="background-color: #f3f3f3; height:100%">
                    ...
                    <input type="hidden" data-handle="rotate" name="rotate_image" value="0">
                    <input type="hidden" data-handle="operator" name="operator_image" value="+">
                </div>
            </div>
        </div>
        <div class="btn-group">
            <div class="btn btn-light btn-sm btn-file">
                Choose file 
                <input type="file" name="image" accept="image/*" data-handle="uploadImage" class="hide">
                <input type="hidden" data-handle="hiddenImage" name="image" value="https://z1s3.s3.ap-southeast-1.amazonaws.com/assets/photo-front.jpg">
            </div>
